...
class User_satu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $select = $this->db->where('relasi = ', 'Lama');
        ...
        $select = $this->db->select('*');
        //$lama = $this->db->where('relasi = ', 'Lama');
        $data['usaha'] = $this->Models->Get_All('usaha', $select, $lama);
        ...
        foreach ($GetUser->result() as $u) {
            ...
            $this->db->query("UPDATE telleseling SET oleh =  '$u->nama' WHERE id_perusahaan = '" . $u->id_perusahaan . "'");
        }
        ...
        $sekarang = date('Y-m-d');
        $select = $this->db->select('*');
        $select = $this->db->where('jumlah = ', $sekarang);
        $data['followup'] = $this->Models->Get_All('telleseling', $select);
        ...
        $select = $this->db->select('*');
        //$select = $this->db->limit('500');
        $select = $this->db->where('nama =', $this->session->userdata('username'));
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/dashboard');
        $this->load->view('templates_satu/footer');
        //$this->load->view('templates_satu/script');
    }
    ...
    public function telleseling_detail()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/telleseling_detail', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function usaha()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/usaha', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function usaha_add()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/usaha_add');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function usaha_id()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/usaha_id', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function mahasiswa()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/mahasiswa', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function mahasiswa_add()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/mahasiswa_add');
        $this->load->view('templates_satu/footer_mhs');
    }
    ...
    public function mahasiswa_id()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/mahasiswa_id', $data);
        $this->load->view('templates_satu/footer_mhs');
    }
    ...
    public function mahasiswa_update()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/mahasiswa_update');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function user_id()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/user_id');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function user_add()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/user_add');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function perusahaan()
    {
        ...
        $select = $this->db->select('*');
        $select = $this->db->where('nama =', $this->session->userdata('username'));
        $data['per'] = $this->Models->Get_All('perusahaan', $select);
        ...
        if ($bidang == "all") {
            ...
            //     $select = $this->db->where('nama =', $this->session->userdata('username'));
            $data['perusahaan'] = $this->Models->Get_All('perusahaan', $select);
            $nama = $this->db->where('nama =', $this->session->userdata('username'));
            $data['nama'] = $this->Models->Get_All('perusahaan', $nama);
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/perusahaan');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function aktif()
    {
        ...
        $this->Models->update($where, $date, 'telleseling');
        $this->Models->update($where, $datu, 'ht_permintaan');
        $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-dismissible fade show" role="alert">
        <strong>Data Non Aktif</strong>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>');
        redirect('user_satu/perusahaan');
    }
    ...
    public function perusahaan_id()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/perusahaan_id');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function perusahaan_add()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/perusahaan_add');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function telleseling()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/telleseling');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function list_feedback()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/list_feedback');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function telleseling_add()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/telleseling_add', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function telleseling_add_aksi()
    {
        ...
        redirect('user_satu/telleseling');
    }
    ...
    public function feedback_add()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/feedback_add', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function getPerusahaan()
    {
        ...
        $this->load->view('user_satu/getPerusahaan', $data);
    }
    ...
    public function getP()
    {
        ...
        $this->load->view('user_satu/getP', $data);
    }
    ...
    public function telleseling_id()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/telleseling_id', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function getMahasiswa()
    {
        ...
        $this->load->view('user_satu/getMahasiswa', $data);
    }
    ...
    public function getKota()
    {
        ...
        $this->load->view('user_satu/getKota', $data);
    }
    ...
    public function getKelas()
    {
        ...
        $this->load->view('user_satu/getKelas', $data);
    }
    ...
    public function permintaan()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/permintaan');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function permintaan_add()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/permintaan_add', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function permintaan_id()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/permintaan_id', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function update_dt()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/update_dt', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function tentang()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/tentang');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function profile()
    {
        ...
        $where = $this->db->where('akses = "user_satu"');
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/profile', $data, $where);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function update_profile()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/update_profile');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function dokumen_det()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/dokumen_det');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function laporan_status_mahasiswa()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/laporan_status_mahasiswa');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function cetak_laporan_status_mahasiswa()
    {
        ...
        $this->load->view('user_satu/cetak_laporan_status_mahasiswa', $data);
    }
    ...
    public function laporan_relasi_perusahaan()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/laporan_relasi_perusahaan');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function halaman_laporan_relasi_perusahaan()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/halaman_laporan_relasi_perusahaan', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function cetak_laporan_relasi_perusahaan()
    {
        ...
        $this->load->view('user_satu/cetak_laporan_relasi_perusahaan', $data);
    }
    ...
    public function akumulasi()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/akumulasi');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function rekapitulasi_penempatan()
    {
        ...
        $data['segera'] = $this->Models->Get_All('telleseling', $select);*/
            ...
            $this->load->view('templates_satu/header', $data);
            $this->load->view('templates_satu/sidebar', $data);
            $this->load->view('user_satu/rekapitulasi_penempatan_keatas', $data);
            $this->load->view('templates_satu/footer');
        ...
        $data['segera'] = $this->Models->Get_All('telleseling', $select);*/
            ...
            $this->load->view('templates_satu/header', $data);
            $this->load->view('templates_satu/sidebar', $data);
            $this->load->view('user_satu/rekapitulasi_penempatan', $data);
            $this->load->view('templates_satu/footer');
        } elseif ($tahun_akademik != 2019) {
            $where = array(
                'tahun_akademik' => $tahun_akademik,
    ...
    public function jumlah_mou()
    {
        ...
        $this->load->view('user_satu/jumlah_mou', $data);
    }
    ...
    public function laporan_followup()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/laporan_followup');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function cetak_laporan_followup()
    {
        ...
        $data['dari'] = $this->input->get('dari');
        $data['sampai'] = $this->input->get('sampai');
        $this->load->view('user_satu/cetak_laporan_followup', $data);
    }
    ...
    public function laporan_feedback()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/laporan_feedback');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function cetak_laporan_feedback()
    {
        ...
        $data['dari'] = $this->input->get('dari');
        $data['sampai'] = $this->input->get('sampai');
        $this->load->view('user_satu/cetak_laporan_feedback', $data);
    }
    ...
    public function laporan_permintaan()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/laporan_permintaan_tanggal');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function cetak_laporan_permintaan_tanggal()
    {
        ...
        $pr = $this->db->group_by('nama_perusahaan');
        ...
        $this->load->view('user_satu/cetak_laporan_permintaan_tanggal', $data);
    }
    ...
    public function laporan_permintaan_perusahaan()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/laporan_permintaan_perusahaan');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function cetak_laporan_permintaan_perusahaan()
    {
        ...
        $this->load->view('user_satu/cetak_laporan_permintaan_perusahaan', $data);
    }
    ...
    public function cetak_laporan_proses_penempatan_mahasiswa()
    {
        ...
        $this->load->view('user_satu/cetak_laporan_proses_penempatan', $data);
    }
    ...
    public function claporan_proses_penempatan_mahasiswa()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/claporan_proses_penempatan_mahasiswa', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function laporan_followup_perusahaan()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/laporan_followup_perusahaan');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function cetak_laporan_followup_perusahaan()
    {
        ...
        $this->load->view('user_satu/cetak_laporan_followup_perusahaan', $data);
    }
    ...
    /*$this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/pilih_grafik');
        $this->load->view('templates_satu/footer');
    }*/
 ...
 //-----BEL NOTIFIKASI-----//
    ...
    /* $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/grafik', $data);
        $this->load->view('templates_satu/footer');
        $this->load->view('templates_satu/script');
    }*/
    ...
    public function serapan()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/serapan');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function serapan_ket()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/serapan_ket', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function prodi()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/prodi');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function serapan_prodi()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/serapan_prodi', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function tambah_kandidat()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/tambah_kandidat', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function master_prodi()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/master_prodi');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function prodi_add()
    {
        ...
        redirect('User_satu/master_prodi');
    }
    ...
    public function kelas()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/kelas');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function laporan_fu_perusahaan()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/laporan_fu_perusahaan');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function cetak_laporan_fu_perusahaan()
    {
        ...
        $this->load->view('user_satu/cetak_laporan_fu_perusahaan', $data);
    }
    ...
    public function belum_kerja()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/belum_kerja');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function rekapitulasi_belum_kerja()
    {
        ...
        $data['segera'] = $this->Models->Get_All('telleseling', $select);*/
            ...
            $this->load->view('templates_satu/header', $data);
            $this->load->view('templates_satu/sidebar', $data);
            $this->load->view('user_satu/rekapitulasi_belum_kerja', $data);
            $this->load->view('templates_satu/footer');
        } else {
            $where = array(
                'tahun_akademik' => $tahun_akademik,
    ...
    public function breakdown()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/breakdown');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function breakdown_id()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/breakdown_id', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function breakdown_bulan()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/breakdown_bulan');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function data_breakdown_bulan()
    {
        ...
        $data['segera'] = $this->Models->Get_All('telleseling', $select);*/
            ...
            $this->load->view('templates_satu/header', $data);
            $this->load->view('templates_satu/sidebar', $data);
            $this->load->view('user_satu/data_breakdown_bulan', $data);
            $this->load->view('templates_satu/footer');
        } else {
            $where = array(
                'tahun_akademik' => $tahun_akademik,
    ...
    public function presentase_penempatan()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/presentase_penempatan');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function presentase_penempatan_data()
    {
        ...
        $data['segera'] = $this->Models->Get_All('telleseling', $select);*/
            ...
            $this->load->view('templates_satu/header', $data);
            $this->load->view('templates_satu/sidebar', $data);
            $this->load->view('user_satu/presentase_penempatan_data', $data);
            $this->load->view('templates_satu/footer');
        } else {
            $select = $this->db->select('*');
            $select = $this->db->where('tahun_akademik', $_GET['tahun_akademik']);
    ...
    public function pilih_target()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/pilih_target');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function pilihan()
    {
        ...
        if ($pilih == "triwulan") {
            ...
            $this->load->view('templates_satu/header', $data);
            $this->load->view('templates_satu/sidebar', $data);
            $this->load->view('user_satu/target_triwulan');
            $this->load->view('templates_satu/footer');
        } else {
            $this->sidebar();
            $data = array(
            ...
            $this->load->view('templates_satu/header', $data);
            $this->load->view('templates_satu/sidebar', $data);
            $this->load->view('user_satu/target_bulan');
            $this->load->view('templates_satu/footer');
        }
    }
    ...
    public function pilih_permintaan()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/pilih_permintaan');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function pilih_followup()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/pilih_followup');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function pilih_rekapitulasi()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/pilih_rekapitulasi');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function pilihan_rekapitulasi()
    {
        ...
        $data['belum'] = $this->Models->Get_All('telleseling', $select);*/
            ...
            $this->load->view('templates_satu/header', $data);
            $this->load->view('templates_satu/sidebar', $data);
            $this->load->view('user_satu/cetak_laporan_mahasiswa');
            $this->load->view('templates_satu/footer');
        ...
        $data['belum'] = $this->Models->Get_All('telleseling', $select);*/
            ...
            $this->load->view('templates_satu/header', $data);
            $this->load->view('templates_satu/sidebar', $data);
            $this->load->view('user_satu/laporan_penerima_lulusan');
            $this->load->view('templates_satu/footer');
        }
    }
    ...
    public function cetak_laporan_penerima_lulusan()
    {
        ...
        $this->load->view('user_satu/cetak_laporan_penerima_lulusan', $data);
    }
    ...
    public function pilih_serapan()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/pilih_serapan');
        $this->load->view('templates_satu/footer');
    }
    ...
    public function target_bulan_id()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/target_id', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function target_triwulan_id()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/target_triwulan_id', $data);
        $this->load->view('templates_satu/footer');
    }
    ...
    public function pilih_perusahaan()
    {
        ...
        $this->load->view('templates_satu/header', $data);
        $this->load->view('templates_satu/sidebar', $data);
        $this->load->view('user_satu/pilih_perusahaan');
        $this->load->view('templates_satu/footer');
    }
}
