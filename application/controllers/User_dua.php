...
class user_dua extends CI_Controller
{
    ...
    public function index()
    {
       ...
       /* $GetFeedback = $this->db->query('select*,DATEDIFF(CURRENT_DATE(), tanggal_accept) as Total_Feedback FROM telleseling');
        ...
        $select = $this->db->select('*');
        $lama = $this->db->where('relasi = ', 'Baru');
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/dashboard');
        $this->load->view('templates_dua/footer');
    }
        ...
        public function telleseling_detail()
    {
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/telleseling_detail', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function usaha()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/usaha', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function usaha_add()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/usaha_add');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function usaha_id()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/usaha_id', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function mahasiswa()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/mahasiswa', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function mahasiswa_add()
    {
       ...
       $select = $this->db->select('*, mahasiswa.nim as nim');
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/mahasiswa_add');
        $this->load->view('templates_dua/footer_mhs');
    }
    ...
    public function mahasiswa_id()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/mahasiswa_id', $data);
        $this->load->view('templates_dua/footer_mhs');
    }
    ...
    public function mahasiswa_update()
    {
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/mahasiswa_update');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function user_id()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/user_id');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function user_add()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/user_add');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function perusahaan()
    {
       ...
       //-----BEL NOTIFIKASI-----//
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/perusahaan');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function perusahaan_id()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/perusahaan_id');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function perusahaan_add()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/perusahaan_add');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function telleseling()
    {
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/telleseling');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function list_feedback()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/list_feedback');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function telleseling_add()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/telleseling_add', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function feedback_add()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/feedback_add', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function getPerusahaan()
    {
        ...
        $this->load->view('user_dua/getPerusahaan', $data);
    }
    ...
    public function getP()
    {
        ...
        $this->load->view('user_dua/getP', $data);
    }
    ...
    public function telleseling_id()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/telleseling_id', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function getMahasiswa()
    {
        ...
        $this->load->view('user_dua/getMahasiswa', $data);
    }
    ...
    public function getKota()
    {
        ...
        $this->load->view('user_dua/getKota', $data);
    }
    ...
    public function getKelas()
    {
        ...
        $this->load->view('user_dua/getKelas', $data);
    }
    ...
    public function permintaan()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/permintaan');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function permintaan_add()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/permintaan_add', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function permintaan_id()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/permintaan_id', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function update_dt()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/update_dt', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function tentang()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/tentang');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function profile()
    {
        ...
        $where = $this->db->where('akses = "user_dua"');
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/profile', $data, $where);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function update_profile()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/update_profile');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function dokumen_det()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/dokumen_det');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function laporan_status_mahasiswa()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/laporan_status_mahasiswa');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function cetak_laporan_status_mahasiswa()
    {
        ...
        $this->load->view('user_dua/cetak_laporan_status_mahasiswa', $data);
    }
    ...
    public function laporan_relasi_perusahaan()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/laporan_relasi_perusahaan');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function halaman_laporan_relasi_perusahaan()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/halaman_laporan_relasi_perusahaan', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function cetak_laporan_relasi_perusahaan()
    {
        ...
        $this->load->view('user_dua/cetak_laporan_relasi_perusahaan', $data);
    }
    ...
    public function akumulasi()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/akumulasi');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function rekapitulasi_penempatan()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        //-----------------------//*/
            ...
            $this->load->view('templates_dua/header', $data);
            $this->load->view('templates_dua/sidebar', $data);
            $this->load->view('user_dua/rekapitulasi_penempatan_keatas', $data);
            $this->load->view('templates_dua/footer');
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        //-----------------------//*/
            ...
            $this->load->view('templates_dua/header', $data);
            $this->load->view('templates_dua/sidebar', $data);
            $this->load->view('user_dua/rekapitulasi_penempatan', $data);
            $this->load->view('templates_dua/footer');
        } elseif ($tahun_akademik != 2019) {
            $where = array(
                'tahun_akademik' => $tahun_akademik,
    ...
    public function jumlah_mou()
    {
        ...
        $this->load->view('user_dua/jumlah_mou', $data);
    }
    ...
    public function laporan_followup()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/laporan_followup');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function cetak_laporan_followup()
    {
        ...
        $data['dari'] = $this->input->get('dari');
        $data['sampai'] = $this->input->get('sampai');
        $this->load->view('user_dua/cetak_laporan_followup', $data);
    }
    ...
    public function laporan_feedback()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/laporan_feedback');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function cetak_laporan_feedback()
    {
        ...
        $data['dari'] = $this->input->get('dari');
        $data['sampai'] = $this->input->get('sampai');
        $this->load->view('user_dua/cetak_laporan_feedback', $data);
    }
    ...
    public function laporan_permintaan_tanggal()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/laporan_permintaan_tanggal');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function cetak_laporan_permintaan_tanggal()
    {
        ...
        $this->load->view('user_dua/cetak_laporan_permintaan_tanggal', $data);
        ...
        public function laporan_permintaan_perusahaan()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/laporan_permintaan_perusahaan');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function cetak_laporan_permintaan_perusahaan()
    {
        ...
        $this->load->view('user_dua/cetak_laporan_permintaan_perusahaan', $data);
    }
    ...
    public function cetak_laporan_proses_penempatan_mahasiswa()
    {
       ...
       //---KERJA---//
        ...
        $this->load->view('user_dua/cetak_laporan_proses_penempatan', $data);
    }
        ...
        public function claporan_proses_penempatan_mahasiswa()
    {
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/claporan_proses_penempatan_mahasiswa', $data);
        $this->load->view('templates_dua/footer');
    }
        ...
        public function laporan_followup_perusahaan()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/laporan_followup_perusahaan');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function cetak_laporan_followup_perusahaan()
    {
        ...
        $this->load->view('user_dua/cetak_laporan_followup_perusahaan', $data);
    }
    ...
    /*public function pilih_grafik()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        /*$this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/pilih_grafik');
        $this->load->view('templates_dua/footer');
    }*/
    ...
    /*public function grafik()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        /*$this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/grafik', $data);
        $this->load->view('templates_dua/footer');
        $this->load->view('templates_dua/script');
    }*/
        ...
        public function serapan()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/serapan');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function serapan_ket()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/serapan_ket', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function serapan_prodi()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/serapan_prodi', $data);
        $this->load->view('templates_dua/footer');
    }
        ...
        public function tambah_kandidat()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/tambah_kandidat', $data);
        $this->load->view('templates_dua/footer');
    }
        ...
        public function master_prodi()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/master_prodi');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function prodi_add()
    {
        ...
        redirect('User_dua/master_prodi');
    }
            ...
            public function laporan_fu_perusahaan()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/laporan_fu_perusahaan');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function cetak_laporan_fu_perusahaan()
    {
        ...
        $this->load->view('user_dua/cetak_laporan_fu_perusahaan', $data);
    }
        ...
        public function belum_kerja()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/belum_kerja');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function rekapitulasi_belum_kerja()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        //-----------------------//*/
            ...
            $this->load->view('templates_dua/header', $data);
            $this->load->view('templates_dua/sidebar', $data);
            $this->load->view('user_dua/rekapitulasi_belum_kerja', $data);
            $this->load->view('templates_dua/footer');
        } else{
            $where = array(
                'tahun_akademik' => $tahun_akademik,
        ...
        public function breakdown()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/breakdown');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function breakdown_id()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/breakdown_id', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function breakdown_bulan()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/breakdown_bulan');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function data_breakdown_bulan()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        //-----------------------//*/
            ...
            $this->load->view('templates_dua/header', $data);
            $this->load->view('templates_dua/sidebar', $data);
            $this->load->view('user_dua/data_breakdown_bulan', $data);
            $this->load->view('templates_dua/footer');
        } else {
            $where = array(
                'tahun_akademik' => $tahun_akademik,
        ...
        public function presentase_penempatan()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/presentase_penempatan');
        $this->load->view('templates_dua/footer');
    }
        ...
        public function presentase_penempatan_data()
    {
       ...
       /* $select = $this->db->where('oleh = ', NULL);
        ...
        //-----------------------//*/
            ...
            $this->load->view('templates_dua/header', $data);
            $this->load->view('templates_dua/sidebar', $data);
            $this->load->view('user_dua/presentase_penempatan_data', $data);
            $this->load->view('templates_dua/footer');
        } else {
            $select = $this->db->select('*');
            $select = $this->db->where('tahun_akademik', $_GET['tahun_akademik']);
        ...
        public function pilih_target()
    {
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/pilih_target');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function pilihan()
    {
        ...
        if ($pilih == "triwulan") {
            ...
            $this->load->view('templates_dua/header', $data);
            $this->load->view('templates_dua/sidebar', $data);
            $this->load->view('user_dua/target_triwulan');
            $this->load->view('templates_dua/footer');
        } else {
            $this->sidebar();
            $data = array(
            ...
            $this->load->view('templates_dua/header', $data);
            $this->load->view('templates_dua/sidebar', $data);
            $this->load->view('user_dua/target_bulan');
            $this->load->view('templates_dua/footer');
        }
    }
        ...
        public function pilih_permintaan()
    {
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/pilih_permintaan');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function pilih_followup()
    {
       ...
       //-----BEL NOTIFIKASI-----//
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/pilih_followup');
        $this->load->view('templates_dua/footer');
    }
    ...
    public function pilih_rekapitulasi()
    {
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/pilih_rekapitulasi');
        $this->load->view('templates_dua/footer');
    }
...
//-----BEL NOTIFIKASI-----//
        ...
        $data['belum'] = $this->Models->Get_All('telleseling', $select);*/
            ...
            $this->load->view('templates_dua/header', $data);
            $this->load->view('templates_dua/sidebar', $data);
            $this->load->view('user_dua/cetak_laporan_mahasiswa');
            $this->load->view('templates_dua/footer');
        ...
        $data['belum'] = $this->Models->Get_All('telleseling', $select);*/
            ...
            $this->load->view('templates_dua/header', $data);
            $this->load->view('templates_dua/sidebar', $data);
            $this->load->view('user_dua/laporan_penerima_lulusan');
            $this->load->view('templates_dua/footer');
        }
    }
     ...
     public function cetak_laporan_penerima_lulusan()
    {
        ...
        $this->load->view('user_dua/cetak_laporan_penerima_lulusan', $data);
    }
    ...
    public function pilih_serapan()
    {
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/pilih_serapan');
        $this->load->view('templates_dua/footer');
    }
        ...
        public function target_bulan_id()
    {
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/target_id', $data);
        $this->load->view('templates_dua/footer');
    }
        ...
        public function target_triwulan_id()
    {
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/target_triwulan_id', $data);
        $this->load->view('templates_dua/footer');
    }
    ...
    public function pilih_perusahaan()
    {
        ...
        $this->load->view('templates_dua/header', $data);
        $this->load->view('templates_dua/sidebar', $data);
        $this->load->view('user_dua/pilih_perusahaan');
        $this->load->view('templates_dua/footer');
    }
}
