...
<div class="card card-primary">
    ...
    <div class="card-body">
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            ?>
                    ...
                    <tr>
                        <td><a href="<?= base_url('') ?>user_satu/update_dt?id_permintaan=<?= $dt->id_permintaan ?>&nim=<?= $dt->nim ?>"><?= $dt->nim ?></a></td>
                        <td><?= $dt->nama_mhs ?></td>
                        <td><?= $dt->kelas ?></td>
                        <td><?= $dt->prodi ?></td>
    ...
    <div class="card-footer">
        ...
        <a class="btn btn-primary btn-sm" href="<?= base_url('') ?>user_satu/tambah_kandidat?id_permintaan=<?= $dt->id_permintaan ?>">
...
<script>
    ...
    function ubah(id_permintaan, nama_perusahaan, bidang, relasi, alamat, kontak_person, jabatan, no_telp, posisi_yang_dibutuhkan, kualifikasi) {
        ...
        document.form.action = '<?= base_url('User_satu/permintaan_update_aksi'); ?>';
    }
    ...
    function hapus(id_permintaan, nama_perusahaan) {
        ...
        document.form.action = '<?= base_url('User_satu/permintaan_delete'); ?>';
    }
</script>