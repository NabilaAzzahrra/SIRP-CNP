                ...
                <div class="modal-body">
                    ...
                    <span id="modal-body-update-or-create">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label>Nama Mahasiswa</label>
                                <input type="text" name="nama_mhs" class="form-control" placeholder="Nama Mahasiswa"  readonly>
                            </div>
                            <div class="form-group col-md-4">
                                <label>Prodi</label>
                                <input type="text" name="prodi" class="form-control" placeholder="Prodi"readonly >
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-2">
                            ...
                            <div class="form-group col-md-4">
                                <label>Asal Sekolah</label>
                                <input type="text" name="asal_sekolah" class="form-control" placeholder="Asal Sekolah"   readonly>
                            </div>
                            <div class="form-group col-md-2">
                                <label>Status</label>
                            ...
                            <div id="lain" class="form-group col-md-3">
                                <label>Tanggal Mulai</label>
                                <input type="date" name="ket_lain" class="form-control" placeholder="Tanggal Mulai" >
                            </div>
                        </div>
...
<script>
    ...
    function ubah(id_permintaan, nim, nama_mhs, prodi, kelas, asal_sekolah, hasil, status, ket, ket_lain, tgl_hasil) {
        ...
        document.form.action = '<?= base_url('User_satu/dt_update_aksi'); ?>';
    }
    ...
    function hapus(id_permintaan,nim, nama_mhs) {
        ...
        document.form.action = '<?= base_url('User_satu/dt_delete'); ?>';
    }
</script>