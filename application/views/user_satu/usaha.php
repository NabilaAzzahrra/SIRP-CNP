...
<div class="row">
    ...
    <div class="col-12 col-sm-6 col-md-2">
        <div class="info-box mb-3">
            <span class="info-box-icon bg-cc elevation-1"><a href="<?= base_url('User_satu/usaha') ?>"><i class="fas fa-business-time"></i></a></span>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="<?= base_url('User_satu/usaha_add') ?>" class="btn btn-primary btn-sm">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td tabindex="0" class="sorting_1"><a href="<?= base_url('') ?>user_satu/usaha_id?id_usaha=<?= $m->id_usaha ?>"><?= $m->nim ?></a></td>
                                        <td><?= $m->nama_mhs ?></td>
                                        <td><?= $m->nama_usaha ?></td>
