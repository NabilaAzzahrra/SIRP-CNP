        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline card-primary">
                    <form id="Modal" action="<?= base_url('User_satu/cetak_laporan_followup_perusahaan'); ?>" target="_blank">
                        <div class="card-body">
                            <div class="form-group">
                                <label>Perusahaan</label>
                                <select name="id_telleseling" class="form-control select2 select2-info" data-dropdown-css-class="select2-info" style="width: 100%;" data-placeholder="Pilih Perusahaan" required>
                                    <option value="">--PILIH--</option>
                                    <option value="all">--ALL--</option>
                                    <?php foreach ($telleseling as $p) { ?>
