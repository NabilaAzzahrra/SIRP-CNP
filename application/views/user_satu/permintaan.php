...
<div class="card">
    <div class="card-header">
        <a href="<?= base_url('User_satu/permintaan_add') ?>" class="btn btn-primary btn-sm">
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            ?>
                <tbody>
                    <tr>
                        <td><?= $no++ ?></td>
                        <td><a href="<?= base_url('') ?>user_satu/permintaan_id?id_permintaan=<?= $hd->id_permintaan ?>"><?= $hd->nama_perusahaan ?></a></td>
                        <td><?= $hd->kota ?></td>
