        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline card-primary">
                    <form id="Modal" action="<?= base_url('User_satu/halaman_laporan_relasi_perusahaan'); ?>" target="_blank">
                        <div class="card-body">
                            <div class="form-group">
                                <label>Relasi</label>
                                <select name="relasi" class="form-control select2 select2-info" data-dropdown-css-class="select2-info" style="width: 100%;" data-placeholder="Pilih Prodi" required>
