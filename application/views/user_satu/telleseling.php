...
<div class="card">
    <div class="card-header">
        <a href="<?= base_url('User_satu/telleseling_add') ?>" class="btn btn-primary btn-sm ">
    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('User_satu/telleseling') ?>" method="GET">
            <div class="row">
                <div class="col-md-2">
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                foreach ($telleseling as $t) {
                    ...
                    if ($t->oleh == $this->session->userdata('username')) {

                ?>
                    <tr>
                        <td><?= $no++ ?></td>
                        <td><a href="<?= base_url('') ?>user_satu/telleseling_detail?id_perusahaan=<?= $t->id_perusahaan ?>"><?= $t->nama_perusahaan ?></a></td>
                        <td><?= $t->bidang ?></td>
                        <td><?= $t->alamat ?></td>
