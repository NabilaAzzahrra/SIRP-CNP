...
<script>
    ...
    function tambah() {
        ...
        $('[name="prodi"]').val("");
        $('[name="kelas"]').val("");
        document.form.action = '<?= base_url('User_satu/kelas_add'); ?>';
    }
    ...
    function ubah(id_kelas,prodi, kelas) {
        ...
        document.form.action = '<?= base_url('User_satu/kelas_update'); ?>';
    }
    ...
    function hapus(id_prodi, prodi) {
        ...
        document.form.action = '<?= base_url('User_satu/kelas_delete'); ?>';
    }
</script>