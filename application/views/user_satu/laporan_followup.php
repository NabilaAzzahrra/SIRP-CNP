        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline card-primary">
                    <form action="<?= base_url('User_satu/cetak_laporan_followup'); ?>" target="_blank">
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-block bg-gradient-warning"><i class="fas fa-print"></i></button>
                        </div>
                    </form>
                </div>
            </div>
