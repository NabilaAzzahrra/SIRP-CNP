                ...
                <div class="modal-body">
                    ...
                    <span class="t" id="modal-body-update-or-create">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-8">
                                <label>Hasil Followup</label>
                                <textarea onkeyup="this.value = this.value.toUpperCase()" type="text" name="hasil_fu" class="form-control" placeholder="Hasil Followup" ></textarea>
                    ...
                    <span id="modal-body-feedback">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea onkeyup="this.value = this.value.toUpperCase()" type="text" name="hasil_feedback" class="form-control" placeholder="Hasil Feedback" ></textarea>
...
<script>
    ...
    function feedback(id_telleseling) {
        ...
        document.form.action = '<?= base_url('User_dua/fb'); ?>';
    }
    ...
    function ubah(id_telleseling, nama_perusahaan, bidang, relasi, alamat, kontak_person, jabatan, no_telp, melalui, tanggal_fu, hasil_fu) {
        ...
        document.form.action = '<?= base_url('User_dua/telleseling_update_aksi'); ?>';
    }
    ...
    function hapus(id_telleseling, nama_perusahaan) {
        ...
        document.form.action = '<?= base_url('User_dua/telleseling_delete'); ?>';
    }
