...
<div class="card card-primary">
    <div class="card-body">
        <form name="form" action="<?= base_url('User_dua/perusahaan_add_aksi') ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-2">
                    <label>MOU</label>
                    <select id="mou" name="sudah_mou" class="form-control" value="<?= set_value('mou') ?>">
