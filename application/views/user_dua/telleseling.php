...
<div class="card">
    <div class="card-header">
        <a href="<?= base_url('User_dua/telleseling_add') ?>" class="btn btn-primary btn-sm ">
    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('User_dua/telleseling') ?>" method="GET">
            <div class="row">
                <div class="col-md-2">
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td><?= $no++ ?></td>
                        <td><a href="<?= base_url('') ?>user_dua/telleseling_id?id_telleseling=<?= $t->id_telleseling ?>"><?= $t->nama_perusahaan ?></a></td>
                        <td><?= $t->bidang ?></td>
                        <td><?= $t->alamat ?></td>
