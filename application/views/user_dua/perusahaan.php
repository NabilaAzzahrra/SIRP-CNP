...
<div class="card">
    <div class="card-header">
        <a href="<?= base_url('User_dua/perusahaan_add') ?>" class="btn btn-primary btn-sm <?php if (count($perusahaan) == 500) {
                                                                                                echo "disabled";
                                                                                            } ?>">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <form action="<?= base_url('User_dua/perusahaan') ?>" method="GET">
            <div class="row">
                <div class="col-md-2">
            ...
            <tbody>
                ...
                ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><a href="<?= base_url('') ?>user_dua/perusahaan_id?id_perusahaan=<?= $p->id_perusahaan ?>"><?= $p->nama_perusahaan ?></a></td>
                                <td><?= $p->bidang ?></td>
                                <td><?= $p->alamat ?></td>
                                <td><?= $p->kota ?></td>
...
<script>
    function aktif(id_perusahaan, nama_perusahaan) {
        ...
        document.form.action = '<?= base_url('User_dua/aktif'); ?>';
    }
</script>