    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-2">
                ...
                <input value="<?= $p->nama ?>" class="form-control form-control-sm" disabled>
            </div>
        </div>

    </div>
    <div class="card-footer">
        <a onclick="return ubah(`<?= $p->id_perusahaan ?>`,`<?= $p->nama_perusahaan ?>`,`<?= $p->bidang ?>`,`<?= $p->type_perusahaan ?>`,`<?= $p->alamat ?>`,`<?= $p->kota ?>`,`<?= $p->email ?>`,`<?= $p->fax ?>`,`<?= $p->kode_pos ?>`,`<?= $p->tingkat ?>`,`<?= $p->kontak_person ?>`,`<?= $p->jabatan ?>`,`<?= $p->no_telp ?>`,`<?= $p->tanggal_mulai ?>`,`<?= $p->tanggal_berakhir ?>`,`<?= $p->sudah_mou ?>`,`<?= $p->sumber ?>`,`<?= $p->ket ?>`,`<?= $p->relasi ?>`,`<?= $p->nama ?>`)" class="btn btn-primary btn-sm">
            <i class="fas fa-edit"></i> Ubah
        </a>
        <a class="btn btn-danger btn-sm" onclick="return hapus(`<?= $p->id_perusahaan ?>`,`<?= $p->nama_perusahaan ?>`)">
            <i class="fas fa-trash"></i> Hapus
        </a>
        <a class="btn btn-success btn-sm" href="<?= base_url('Master/perusahaan') ?>">
                ...
                <div class="modal-body">
                    ...
                    <span id="modal-body-update-or-create">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label>Keterangan</label>
                                <textarea onkeyup="this.value = this.value.toUpperCase()" type="text" name="ket" class="form-control form-control-sm" placeholder="Keterangan" ></textarea>
                            </div>
                            <div class="form-group col-md-2">
                                <label>Relasi</label>
                            ...
                            <div class="form-group col-md-3">
                                <label>Acount Executive</label>
                                <select name="nama" class="form-control form-control-sm select2 select2-primary" data-dropdown-css-class="select2-primary" style="width: 100%;" data-placeholder="Account Executive">
                                    <option value="">--PILIH--</option>
...
<script>
    function ubah(id_perusahaan, nama_perusahaan, bidang, type_perusahaan, alamat, kota, email, fax, kode_pos, tingkat, kontak_person, jabatan, no_telp, tanggal_mulai, tanggal_berakhir, sudah_mou,sumber, ket, relasi, nama) {
        $('#Modal').modal('show');
        ...
        $('[name="nama"]').val(nama).trigger('change');
