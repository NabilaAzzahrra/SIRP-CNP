            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="<?= base_url('Master/mahasiswa_add') ?>" class="btn btn-primary btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('Master/mahasiswa') ?>" method="GET">
                            <div class="row">
                                <div class="col-md-2">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td tabindex="0" class="sorting_1"><a href="<?= base_url('') ?>master/mahasiswa_id?nim=<?= $m->nim ?>"><?= $m->nim ?></a></td>
                                        <td><?= $m->nama_mhs ?></td>
                                        <td><?= $m->prodi ?></td>
                                        <td><?= $m->kelas ?></td>
                                        <td><?= $m->ipk ?></td>
