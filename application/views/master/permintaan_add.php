    ...
    <div class="card-body">
        <form id="Modal" name="form" action="" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
            ...
            <div class="form-group">
                ...
                <select name="id_perusahaan" class="form-control select2 select2-info" data-dropdown-css-class="select2-info" style="width: 100%;" data-placeholder="Pilih Perusahaan" onchange="return getPerusahaan()" required>
            ...
            <div class="form-group">
                ...
                <input onkeyup="this.value = this.value.toUpperCase()" type="text" name="posisi_yang_dibutuhkan" class="form-control" placeholder="Posisi yang dibutuhkan" maxlength="50" required>
            ...
            <div class="form-group">
                ...
                <select name="nim" class="form-control select2 select2-info" data-dropdown-css-class="select2-info" style="width: 100%;" data-placeholder="Pilih Mahasiswa" onchange="return getMahasiswa()">
                    <option value="">--PILIH--</option>
...
<script>
    ...
    function tambah() {
        ...
        $("[name='form']").attr('action', '<?= base_url('Master/SavePermintaan'); ?>');
    }
</script>