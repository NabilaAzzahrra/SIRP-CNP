...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('assets/template'); ?>/plugins/chart.js/Chart.min.css">
  ...
  <link rel="stylesheet" href="<?= base_url('assets/template') ?>/plugins/datatables-buttons/css/buttons.bootstrap4.min.css"> <!-- Theme style -->
