...
<body class="hold-transition sidebar-mini text-sm">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-menu elevation-4">
            <!-- Brand Logo -->
            <a href="<?= base_url('User_satu/tentang') ?>" class="brand-link">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="<?= base_url('User_satu/profile') ?>" class="d-block"><?= $this->session->userdata('nama') ?></a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-<?= $this->session->userdata('dashboard') ?>">
                            <a href="<?= base_url('User_satu/index') ?>" class="nav-link<?= $this->session->userdata('dashboard_status') ?>">
                        ...
                        <li class="nav-item menu-<?= $this->session->userdata('master') ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('User_satu/master_prodi') ?>" class="nav-link  <?= $this->session->userdata('master_prodi'); ?>">
                                        <i class="far fa-<?= $this->session->userdata('master_prodi_dot'); ?>circle nav-icon"></i>
                                        <p>Prodi</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('User_satu/kelas') ?>" class="nav-link  <?= $this->session->userdata('kelas'); ?>">
                        ...
                        <li class="nav-item menu-<?= $this->session->userdata('rekap') ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('User_satu/pilih_permintaan') ?>" class="nav-link  <?= $this->session->userdata('pilih_permintaan'); ?>">
                                        <i class="far fa-<?= $this->session->userdata('pilih_permintaan_dot'); ?>circle nav-icon"></i>
                                        <p>Permintaan</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('User_satu/pilih_followup') ?>" class="nav-link  <?= $this->session->userdata('pilih_followup'); ?>">
                                        <i class="far fa-<?= $this->session->userdata('pilih_followup_dot'); ?>circle nav-icon"></i>
                                        <p>Follow Up</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('User_satu/mou') ?>" class="nav-link  <?= $this->session->userdata('mou'); ?>">
                                        <i class="far fa-<?= $this->session->userdata('mou_dot'); ?>circle nav-icon"></i>
                                        <p>Jumlah MOU</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('User_satu/pilih_rekapitulasi') ?>" class="nav-link  <?= $this->session->userdata('pilih_rekapitulasi'); ?>">
                                        <i class="far fa-<?= $this->session->userdata('pilih_rekapitulasi_dot'); ?>circle nav-icon"></i>
                                        <p>Rekapitulasi</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('User_satu/pilih_grafik') ?>" class="nav-link  <?= $this->session->userdata('pilih_grafik'); ?>">
                                        <i class="far fa-<?= $this->session->userdata('pilih_grafik_dot'); ?>circle nav-icon"></i>
                                        <p>Grafik Permintaan Perusahaan</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('User_satu/pilih_serapan') ?>" class="nav-link  <?= $this->session->userdata('pilih_serapan'); ?>">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?= base_url('User_satu/index') ?>">dashboard</a></li>
